...
export type OrderStatusActions = GetOrderStatus | SetOrderStatus | ResetOrderStatus | OnOrderSuccess | OnUpdateCustomer | OnSelectDeliveryMethod | OnSelectPaymentMethod | OnUpdateOrderItems;